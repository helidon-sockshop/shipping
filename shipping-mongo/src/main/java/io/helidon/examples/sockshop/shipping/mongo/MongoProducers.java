...
public class MongoProducers {
    ...
    public static MongoDatabase db(MongoClient client) {
        return client.getDatabase("shipping");
    }

    /**
     * CDI Producer for the {@code MongoCollection} that contains shipments.
     *
     * @param db the MongoDB database to use
     *
     * @return a {@code MongoCollection} containing the shipments
     */
    @Produces
    @ApplicationScoped
